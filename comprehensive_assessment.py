...
# عرض الإجابات في شكل مصفوفة
st.write(f"**Emotional Development:**\n1: {emotional_q1}, 2: {emotional_q2}, 3: {emotional_q3}, 4: {emotional_q4}, 5: {emotional_q5}")
st.write(f"**Social Development:**\n1: {social_q1}, 2: {social_q2}, 3: {social_q3}, 4: {social_q4}, 5: {social_q5}")
st.write(f"**Cognitive Development:**\n1: {cognitive_q1}, 2: {cognitive_q2}, 3: {cognitive_q3}, 4: {cognitive_q4}, 5: {cognitive_q5}")

st.write("### You can now take this matrix and analyze the responses using your preferred software.")
